...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['answer_id'], ['answer.id'], name='question_correct_answers_answer_id_fkey'),
    sa.ForeignKeyConstraint(['question_id'], ['question.id'], name='question_correct_answers_question_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='question_correct_answers_pkey'),
    sa.UniqueConstraint('question_id', 'answer_id', name='question_correct_answers_question_id_answer_id_key')
    )
    # ### end Alembic commands ###
